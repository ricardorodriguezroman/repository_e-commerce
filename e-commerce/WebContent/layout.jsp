		...
		<div id="header">
			<div class="top_right">
				...
				<div class="big_banner">
					<a href="#"><img src="images/banner728.jpg" alt="" border="0" /></a>
				</div>
			</div>
			<div id="logo">
				<a href="#"><img src="images/logo.png" alt="" border="0"
					height="85" width="182" /></a>
			</div>
		</div>
		<div id="main_content">
			<div id="menu_tab">
			...
			<div class="left_content">
				...
				<div class="border_box">
					...
					<div class="product_img">
						<a href="#"><img src="images/p1.jpg" alt="" border="0" /></a>
					</div>
				...
				<div class="border_box">
					<input name="newsletter" class="newsletter_input"
						value="your email" type="text" /> <a href="#" class="join">subscribe</a>
				</div>
			...
			<div class="center_content">
				<div class="oferta">
					<img src="images/p1.png" class="oferta_img" alt="" border="0"
						height="113" width="165" />
				...
				<div class="prod_box">
					...
					<div class="prod_details_tab">
						<a href="#" class="prod_buy">Add to Cart</a> <a href="#"
				...
				<div class="prod_box">
					<div class="center_prod_box">
						...
						<div class="product_img">
							<a href="#"><img src="images/p2.jpg" alt="" border="0" /></a>
						</div>
						<div class="prod_price">
							<span class="reduce">350$</span> <span class="price">270$</span>
						</div>
				...
				<div class="prod_box">
					<div class="center_prod_box">
						...
						<div class="product_img">
							<a href="#"><img src="images/p4.jpg" alt="" border="0" /></a>
						</div>
						<div class="prod_price">
							<span class="reduce">350$</span> <span class="price">270$</span>
						</div>
				...
				<div class="prod_box">
					<div class="center_prod_box">
						...
						<div class="product_img">
							<a href="#"><img src="images/p3.jpg" alt="" border="0" /></a>
						</div>
						<div class="prod_price">
							<span class="reduce">350$</span> <span class="price">270$</span>
						</div>
				...
				<div class="prod_box">
					<div class="center_prod_box">
						...
						<div class="product_img">
							<a href="#"><img src="images/p5.jpg" alt="" border="0" /></a>
						</div>
						<div class="prod_price">
							<span class="reduce">350$</span> <span class="price">270$</span>
						</div>
				...
				<div class="prod_box">
					<div class="center_prod_box">
						...
						<div class="product_img">
							<a href="#"><img src="images/p6.jpg" alt="" border="0" /></a>
						</div>
						<div class="prod_price">
							<span class="reduce">350$</span> <span class="price">270$</span>
						</div>
				...
				<div class="prod_box">
					<div class="center_prod_box">
						...
						<div class="product_img">
							<a href="#"><img src="images/p7.jpg" alt="" border="0" /></a>
						</div>
						<div class="prod_price">
							<span class="reduce">350$</span> <span class="price">270$</span>
						</div>
			...
			<div class="right_content">
				...
				<div class="border_box">
					<input name="newsletter" class="newsletter_input" value="keyword"
						type="text" /> <a href="#" class="join">search</a>
				</div>
